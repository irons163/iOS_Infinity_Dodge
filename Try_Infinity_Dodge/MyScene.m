...
@implementation MyScene{
    ...
    NSMutableArray * skillBtnTextures;
}
...
-(void)createFireballs{
    ...
    fireball.zRotation = [self getAngleByP1:fireball.position P2:player.position];
    
    [self addChild:fireball];
    [fireballs addObject:fireball];
}

-(float)getAngleByP1:(CGPoint)point1 P2:(CGPoint)point2{
    return 0;
}
...
-(void)defen{
    SKSpriteNode * defenArea;
    defenArea.physicsBody = [SKPhysicsBody bodyWithCircleOfRadius:20];
//    defenArea.physicsBody = ;
}
...
-(void)initSkillButtons{
    SKSpriteNode *skillButton1, *skillButton2, *skillButton3, *skillButton4;
    
    skillBtnTextures = [NSMutableArray array];
    [skillBtnTextures addObject:[SKTexture textureWithImageNamed:@"btn_Music-hd"]];
    [skillBtnTextures addObject:[SKTexture textureWithImageNamed:@"btn_Music_Select-hd"]];
    skillButton1.texture = skillBtnTextures[0];

    skillBtnTextures = [NSMutableArray array];
    [skillBtnTextures addObject:[SKTexture textureWithImageNamed:@"btn_Music-hd"]];
    [skillBtnTextures addObject:[SKTexture textureWithImageNamed:@"btn_Music_Select-hd"]];
    skillButton2.texture = skillBtnTextures[0];
    
    skillBtnTextures = [NSMutableArray array];
    [skillBtnTextures addObject:[SKTexture textureWithImageNamed:@"btn_Music-hd"]];
    [skillBtnTextures addObject:[SKTexture textureWithImageNamed:@"btn_Music_Select-hd"]];
    skillButton3.texture = skillBtnTextures[0];
    
    skillBtnTextures = [NSMutableArray array];
    [skillBtnTextures addObject:[SKTexture textureWithImageNamed:@"btn_Music-hd"]];
    [skillBtnTextures addObject:[SKTexture textureWithImageNamed:@"btn_Music_Select-hd"]];
    skillButton4.texture = skillBtnTextures[0]; //defenArea
}
...
//-(void)show{
//    GameMenuViewController* gameMenuDialogViewControll
